        ...
        <div class="property__gallery-container container">
          <div class="property__gallery">
            <div class="property__image-wrapper">
              <img class="property__image" src="img/room.jpg" alt="Photo studio">
            </div>
            <div class="property__image-wrapper">
              <img class="property__image" src="img/apartment-01.jpg" alt="Photo studio">
            </div>
            <div class="property__image-wrapper">
              <img class="property__image" src="img/apartment-02.jpg" alt="Photo studio">
            </div>
            <div class="property__image-wrapper">
              <img class="property__image" src="img/apartment-03.jpg" alt="Photo studio">
            </div>
            <div class="property__image-wrapper">
              <img class="property__image" src="img/studio-01.jpg" alt="Photo studio">
            </div>
            <div class="property__image-wrapper">
              <img class="property__image" src="img/apartment-01.jpg" alt="Photo studio">
            </div>
        ...
        <div class="property__container container">
          <div class="property__wrapper">
            ...
            <div class="property__rating rating">
              ...
              <span class="property__rating-value rating__value">4.8</span>
            </div>
            ...
            <div class="property__price">
              <b class="property__price-value">&euro;120</b>
            ...
            <div class="property__inside">
              ...
              <ul class="property__inside-list">
                <li class="property__inside-item">
                  Wi-Fi
                </li>
                <li class="property__inside-item">
                  Washing machine
            ...
            <div class="property__host">
              ...
              <div class="property__host-user user">
                <div class="property__avatar-wrapper property__avatar-wrapper--pro user__avatar-wrapper">
                  <img class="property__avatar user__avatar" src="img/avatar-angelina.jpg" width="74" height="74"
                       alt="Host avatar">
                </div>
                <span class="property__user-name">
                    Angelina
                  </span>
                <span class="property__user-status">
                    Pro
                  </span>
              </div>
                ...
                <li class="reviews__item">
                  <div class="reviews__user user">
                    <div class="reviews__avatar-wrapper user__avatar-wrapper">
                      <img class="reviews__avatar user__avatar" src="img/avatar-max.jpg" width="54" height="54"
                           alt="Reviews avatar">
                    </div>
